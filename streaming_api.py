...
def stream_chat():
    ...
    return Response(str(generatechatcompletion.generate_chat_completion(consigne, texte, model)), content_type='text/plain')
...
def chat():
    ...
    return Response(str(generatechatcompletion.generate_chat(consigne, texte, system, model)), content_type='text/plain')
